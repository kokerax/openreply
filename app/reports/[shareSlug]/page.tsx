          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="border border-border bg-surface p-4 text-sm text-foreground md:min-w-64">
              ...
              {report.branded && (
                <Link
                  href="/"
                  className="mt-4 inline-flex items-center justify-center border border-info/30 bg-info-soft px-3 py-2 text-xs font-semibold text-info transition hover:border-info"
                >
            ...
            <div>
              ...
              {report.campaign.postUrl ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-3 inline-flex text-sm font-semibold text-accent transition hover:text-info"
                >
                  View Instagram post
                </a>
              ) : (
